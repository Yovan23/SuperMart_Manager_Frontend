...
@Component({
    ...
    standalone: true,
    imports: [
        SnackbarComponent, EditDialogComponent, DeleteDialogComponent, InputText, AddDialogComponent, TableModule, CommonModule, TagModule, ButtonModule
    ],
...
export class CategoryComponent implements OnInit, OnDestroy {
    ...
    updateCategory(updatedCategory: any): void {
        ...
        this.categoryService.updateCategory({ category: updatedCategory, _id: this.selectedCategory._id }).subscribe({
            next: () => {
                this.loadcategory();
                this.editDialogVisible = false;
                this.snackbarService.showSuccess('Category Updated', 'Category details updated successfully!');
            },
            error: (error) => {
                console.error('Error updating category:', error);
                this.snackbarService.showError('Error', 'Failed to update category. Please try again!');
            }
        });
    }
