...
export class ProductComponent implements OnInit, OnDestroy {
  ...
  openEditDialog(product: Product): void {
    ...
    if (this.selectedProduct && this.selectedProduct.categoryId) {
      const categoryId = this.selectedProduct.categoryId as unknown as { _id: string };
 ...
 updateProduct(updatedProduct: any): void {
    ...
    this.productService.updateProduct({ Product: updatedProduct, _id: this.selectedProduct._id }).subscribe({ // Use updatedProduct!
      next: () => {
        this.loadProducts();
  ...
  getCategoryName(categoryId: any): string {
    ...
    const categoryIdStr = typeof categoryId === 'object' ? categoryId._id : categoryId;  // Extract ID if it's an object
    const category = this.categories.find(cat => String(cat._id) === String(categoryIdStr));
